...
def split_and_scale(X, Y):
    ...
    # IMPORTANT: KNN is distance-based, so scaling is CRUCIAL
    # Features with large ranges will dominate the distance calculation
    # For example: weight (50-100) vs binary features (0-1)
    # Without scaling, weight would matter way more than it should
  ...
  #  print("\nRunning algorithm comparison...")
   # algo_results, algo_diff, algo_sensitivity = test_algorithm_sensitivity(X_train, X_test, Y_train, Y_test)
    ...
    with open("knn_sensitivity_results.txt", "w") as f:
        f.write("KNN HYPERPARAMETER SENSITIVITY ANALYSIS - DIABETES DATASET\n\n")
