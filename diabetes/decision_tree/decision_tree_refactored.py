...
def test_max_depth_sensitivity(X_train, X_test, Y_train, Y_test, logger, depth_values=[1, 2, 3, 5, 7, 10, 15, 20, None]):
    ...
    plt.ylabel("Score")
    plt.title("Sensitivity to max_depth (Multiple Metrics) - Diabetes")
    plt.legend()
    plt.grid(True)
...
def test_min_samples_split_sensitivity(X_train, X_test, Y_train, Y_test, logger, split_values=[2, 5, 10, 20, 50, 100]):
    ...
    plt.ylabel("Score")
    plt.title("Sensitivity to min_samples_split (Multiple Metrics) - Diabetes")
    plt.legend()
    plt.grid(True)
...
def test_min_samples_leaf_sensitivity(X_train, X_test, Y_train, Y_test, logger, leaf_values=[1, 2, 5, 10, 20, 50]):
    ...
    plt.ylabel("Score")
    plt.title("Sensitivity to min_samples_leaf (Multiple Metrics) - Diabetes")
    plt.legend()
    plt.grid(True)
...
def test_criterion_sensitivity(X_train, X_test, Y_train, Y_test, logger):
    ...
    plt.xlabel('Metrics')
    plt.ylabel('Score')
    plt.title('Criterion Comparison (All Metrics) - Diabetes')
